...
/**
 * @author Harry class responsible for replaying a recording of a recorded game.
 */
public class Replay {
  ...
  /**
   * @return Boolean finished, whether the replay is finished replaying
   */
  ...
  /**
   * @author Harry A test method that prints a recording object to the console
   */
